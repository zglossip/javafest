...
public class AsciiUtil {
  ...
  public static String getCharacterFromColor(final int r, final int b, final int g, final boolean print) {
    return getCharacterFromColorBw((r + b + g) / 3, print);
  }

  public static String getCharacterFromColorBw(final int color, final boolean print) {
    if (print) {
